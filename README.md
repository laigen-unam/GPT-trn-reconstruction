...
Varela-Vega, A., Posada-Reyes, A. B., & Méndez-Cruz, C. F. (2024). Automatic extraction of transcriptional regulatory interactions of bacteria from biomedical literature using a BERT-based approach. *Database : the journal of biological databases and curation, 2024*, baae094. [https://doi.org/10.1093/database/baae094](https://doi.org/10.1093/database/baae094)
